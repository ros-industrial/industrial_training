...
public:
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> clusterExtraction(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_cloud)
    {
         ...
         * ========================================*/
    pcl::PointCloud<pcl::PointXYZ>::Ptr statOutlier(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_cloud)
    {
         ...
         * ========================================*/
    pcl::PointCloud<pcl::PointXYZ>::Ptr PolygonSegmentation(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_cloud)
    {
